//===- nnsimple-capi-test.c - Simple demo of C-API ------------------------===//
//
...
// RUN: nnsimple-capi-test 2>&1 | FileCheck %s
...
int main(int argc, char **argv) {
  ...
  mlirDialectHandleRegisterDialect(mlirGetDialectHandle__nnsimple__(), ctx);
